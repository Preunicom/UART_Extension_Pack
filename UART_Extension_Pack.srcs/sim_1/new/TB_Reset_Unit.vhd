...
begin
  COMP: Reset_Unit generic map(8) port map(tb_clk, tb_rst, tb_write_en, tb_access_mode, tb_unit_data_in, tb_unit_data_out, tb_scheduler_wanted, tb_scheduler_done, tb_rst_ext_pack);
  ...
  tb_error <= '0' when 
    ...
    and (tb_exp_rst_ext_pack = tb_rst_ext_pack) else '1';
