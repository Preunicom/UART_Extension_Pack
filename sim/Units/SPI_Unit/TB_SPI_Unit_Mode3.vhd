--! @file
--! @brief Testbench for the SPI_Unit with SPI mode 3
--! @details
--! This file contains the testbench for the SPI_Unit entity with SPI mode 3.  
--! It tests:
--! - Normal operation in SPI mode 3

library IEEE;
use IEEE.STD_LOGIC_1164.ALL;

entity TB_SPI_Unit_Mode3 is
  Port (
    tb_error : out std_logic --! '0' if everything works like expected, '1' otherwise.
  );
end TB_SPI_Unit_Mode3;

architecture TESTBENCH of TB_SPI_Unit_Mode3 is
  component SPI_Unit
    Generic (
...
begin
  COMP: SPI_Unit generic map(10000000, 5000000, 2, 8, 3, 0) port map(tb_clk, tb_rst, tb_SCK, tb_send_data, tb_slave_id, tb_write_en, tb_ready, tb_MOSI, tb_CS, tb_received_data, tb_new_data_received, tb_MISO);
