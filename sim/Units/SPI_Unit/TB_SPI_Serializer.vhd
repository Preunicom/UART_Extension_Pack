--! @file
--! @brief Testbench for the SPI_Serializer
--! @details
--! This file contains the testbench for the SPI_Serializer entity.  
--! It tests:
--! - Normal operation
...
entity TB_SPI_Serializer is
  Port (
    tb_error : out std_logic --! '0' if everything works like expected, '1' otherwise.
  );
end TB_SPI_Serializer;

architecture TESTBENCH of TB_SPI_Serializer is
...
begin
  COMP: SPI_Serializer generic map(8, 1, 1) port map(tb_clk, tb_clk_en_prescaled, tb_rst, tb_write_enable, tb_parallel_in, tb_serial_out, tb_buffer_data_saved);

  -- 10 MHz
  CLOCK: process
  begin
    for i in 2000 downto 0 loop
      tb_clk <= '1';
  ...
  tb_write_enable <= '0',
    ...
    '1' after 25*tbase, '0' after 30*tbase;
  ...
  tb_exp_serial_out <= '0',
    '0' after 20*tbase, '0' after 21*tbase, '0' after 22*tbase, '0' after 23*tbase, '1' after 24*tbase, '1' after 25*tbase, '1' after 26*tbase, '1' after 27*tbase, -- (0xF0)
    '1' after 28*tbase, '1' after 29*tbase, '0' after 30*tbase, '0' after 31*tbase, '0' after 32*tbase, '0' after 33*tbase, '0' after 34*tbase, '1' after 35*tbase, '0' after 36*tbase; -- (0x83)

  tb_exp_buffer_data_saved <= 'U', '0' after 1*tbase_half,
    '1' after 20*tbase, '0' after 21*tbase,
