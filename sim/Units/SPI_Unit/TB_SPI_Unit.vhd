--! @file
--! @brief Testbench for the SPI_Unit
--! @details
--! This file contains the testbench for the SPI_Unit entity.  
--! It tests:
--! - Send
--! - Receive
...
begin
  COMP: SPI_Unit generic map(10000000, 5000000, 2, 8, 0, 1) port map(tb_clk, tb_rst, tb_SCK, tb_send_data, tb_slave_id, tb_write_en, tb_ready, tb_MOSI, tb_CS, tb_received_data, tb_new_data_received, tb_MISO);
  ...
  tb_MISO <= '0',
    '0' after 11*tbase, '0' after 13*tbase, '0' after 15*tbase, '0' after 17*tbase, '1' after 19*tbase, '1' after 21*tbase, '1' after 23*tbase, '1' after 25*tbase, --0xF0
    ...
    '0' after 51*tbase, '0' after 53*tbase, '0' after 55*tbase, '0' after 57*tbase, '1' after 59*tbase, '1' after 61*tbase, '0' after 63*tbase, '0' after 65*tbase; --0x30
  ...
  tb_exp_MOSI <= '0',
    '0' after 11*tbase, '1' after 13*tbase, '0' after 15*tbase, '1' after 17*tbase, '0' after 19*tbase, '0' after 21*tbase, '1' after 23*tbase, '1' after 25*tbase, '0' after 27*tbase, --0xCA
    '1' after 31*tbase, '1' after 33*tbase, '0' after 35*tbase, '1' after 37*tbase, '0' after 39*tbase, '0' after 41*tbase, '0' after 43*tbase, '1' after 45*tbase, '0' after 47*tbase, --0x8B
    '1' after 51*tbase, '0' after 53*tbase, '0' after 55*tbase, '0' after 57*tbase, '0' after 59*tbase, '0' after 61*tbase, '0' after 63*tbase, '0' after 65*tbase, '0' after 67*tbase; --0x01
