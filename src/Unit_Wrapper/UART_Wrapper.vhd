...
--! @}
  ...
  Port (
    ...
    access_mode : in std_logic_vector(1 downto 0); --! Access mode: 00: send, others: ignored
    ...
    error_from_host : out std_logic := '0'; --! Error: TX data lost because UART was busy or access mode not 00 was used.
