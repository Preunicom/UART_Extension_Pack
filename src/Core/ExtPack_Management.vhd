...
architecture Behavioral of ExtPack_Management is
  ...
  --! @brief Enable signal vector for the unit input (unit_data_received_internal). 
  ...
  --! The schedule eacknowledge for the units. Acknowledges that the data was processed and sent.
