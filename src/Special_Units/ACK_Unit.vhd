...
--! @}
  ...
  Port ( 
    ...
    write_en : in std_logic; --! Enable signal for the input data. @details One clock cycle earlier than unit data in and access mode.
    access_mode : in std_logic_vector(1 downto 0); --! Access mode from host. 00: Enable/Disable, others: ignored
    ...
    error_from_host : out std_logic := '0'; --! Error flag: Set when a command to this unit with an access mode not 00 is received.
